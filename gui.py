...
from base import home_layout
from form import open_function
from funcs import (
...
def create_gui(tools_list, theme="Reddit", create_console=False, icon=False):
    ...
    while True:
        ...
        if event == "Exit" or event == sg.WIN_CLOSED or event is None:
            ...
            if isinstance(values["-FUNC-LIST-"], list) and len(values["-FUNC-LIST-"]) != 0:
                ...
                open_function(function_name, tools_list, create_console=create_console)
